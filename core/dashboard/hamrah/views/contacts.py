...
class ContactListView(LoginRequiredMixin,HasHamrahAccessPermission, ListView):
    title = "لیست تماس ها"
    template_name = "dashboard/hamrah/contacts/contact-list.html"
    paginate_by = 10
...
class ContactDetailView(LoginRequiredMixin,HasHamrahAccessPermission, DetailView):
    title = "جزئیات تماس"
    template_name = "dashboard/hamrah/contacts/contact-detail.html"
